...
let g2t1 = new Task({belongsTo:'goal2', title: 'This task has due date', dueDate: new Date('03-Feb-2017')});
...
let g4t1 = new Task({belongsTo:'goal4', title: 'This task is completed and has due date', completed:true, dueDate:new Date('22-Jan-2017')});
let g4t2 = new Task({belongsTo:'goal4', title: 'This task is completed and has due date and percentage', completed:true, dueDate:new Date('25-Jan-2017'), percentage:65});
